...
public class AddressBook {
    ...
    int count = 1;
    //using collection as per the requirement of uc7
    static List<Contacts> contacts = new ArrayList<Contacts>();
    static List<Contacts> duplicateCheckedcontacts;
    static List<Contacts> searchByCity;
    static List<Contacts> searchByState;
    static HashMap<String, List<Contacts>> dictionaryCity = new HashMap<>();
    //uc 9 dictionary
